...
ifeq ("darwin_arm64","$(CURRENT_PACKAGE_ARCH)")
	...
	@for plugin_package in $(PLUGIN_PACKAGES) ; do \
		ARCH=$(PLUGIN_ARCH); \
		cp $(MMBUILD_MATERIALS_DIR)/$$plugin_package-$$ARCH.tar.gz $(DIST_PATH_GENERIC)/prepackaged_plugins; \
...
ifeq ($(BUILDER_GOOS_GOARCH),"windows_amd64")
	...
	@for plugin_package in $(PLUGIN_PACKAGES) ; do \
		ARCH="windows-amd64"; \
		cp $(MMBUILD_MATERIALS_DIR)/$$plugin_package-$$ARCH.tar.gz $(DIST_PATH_WIN)/prepackaged_plugins; \
